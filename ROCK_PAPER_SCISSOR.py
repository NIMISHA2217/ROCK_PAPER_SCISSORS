...
# Default image
img_p = Image.open("C:\\Users\\DELL\\Downloads\\deefault.jpg")
...
# Rock image
rock_p = Image.open("C:\\Users\\DELL\\Downloads\\rockk.jpg")
...
# Paper image
paper_p = Image.open("C:\\Users\\DELL\\Downloads\\paper.jpeg")
...
# Scissor image
scissor_p = Image.open("C:\\Users\\DELL\\Downloads\\scissor.jpeg")
...
# Selection image
img_s = Image.open("C:\\Users\\DELL\\Downloads\\selection.jpg")
...
def game(player):
    ...
    result_text = canvas.create_text(390, 600, text='Result:- ' + res, fill="black", font=('Algerian', 25))
    canvas.addtag_withtag('result', result_text)
...
rock_b = Button(root, text='Rock', command=lambda: game(1), bg='lightgray', fg='black', font=('Arial', 12, 'bold'), padx=10, pady=5, borderwidth=2, relief='raised')
rock_b.place(x=20, y=500)

# Button for selecting paper
paper_b = Button(root, text='Paper', command=lambda: game(2), bg='lightgray', fg='black', font=('Arial', 12, 'bold'), padx=10, pady=5, borderwidth=2, relief='raised')
paper_b.place(x=110, y=500)

# Button for selecting scissor
scissor_b = Button(root, text='Scissor', command=lambda: game(3), bg='lightgray', fg='black', font=('Arial', 12, 'bold'), padx=10, pady=5, borderwidth=2, relief='raised')
scissor_b.place(x=210, y=500)

# Button for clear
clear_b = Button(root, text='CLEAR', font=('Arial', 10, 'bold'), bg='red', fg='white', width=10, command=clear)
